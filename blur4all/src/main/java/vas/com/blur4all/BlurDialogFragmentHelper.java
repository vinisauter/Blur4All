...
public class BlurDialogFragmentHelper {
    ...
    public BlurDialogFragmentHelper(@NonNull DialogFragment fragment) {
        mFragment = fragment;
        mAnimDuration = fragment.getResources().getInteger(android.R.integer.config_mediumAnimTime);
    ...
    public void onActivityCreated() {
        ...
        mBlurBgView.setBackgroundColor(ContextCompat.getColor(mFragment.getActivity(), mBgColorResId));
